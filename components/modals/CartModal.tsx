        ...
        {cartLenght ? (
          ...
          <div className="flex flex-col h-full items-center justify-center bg-white">
            <div className="flex flex-col items-center text-center">
              <img src="/box.png" alt="box" className="w-[120px] mb-5" />
              <h2 className="font-semibold text-[1.38rem] mb-1.5">
                Корзина пустая
              </h2>
              <p className="max-w-[285px] opacity-40 mb-9.25">
                Добавьте хотя бы одну пиццу, чтобы совершить заказ
              </p>
              <button
                onClick={() => setOpenCart(false)}
                className="text-[1rem] text-white flex items-center justify-center gap-2.5 bg-(--orange) px-[2.25rem] py-[1rem] rounded-2xl hover:opacity-90 cursor-pointer"
              >
                <svg
                  width="16"
                  height="14"
